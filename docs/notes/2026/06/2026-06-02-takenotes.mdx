...
<Steps>
  ...
  <Step title="Decide whether this is a pillar, case study, or section">
    ...
    For example, a new Cloudflare/Caddy observation should usually update [[cloudflare-ip-dns]] instead of becoming a fresh article. A citation-validator implementation belongs near [[source-maps-chunk-citations-and-citation-validation]], not in another generic Perplexity post.
  </Step>
