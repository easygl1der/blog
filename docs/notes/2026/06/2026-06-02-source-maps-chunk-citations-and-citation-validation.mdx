...
This note focuses only on citation integrity. The broader search pipeline is covered in [Recreate Perplexity Search With LangFlow](/docs/notes/2026/06/2026-06-02-recreate-perplexity-search-with-langflow), and the search-versus-crawler boundary is covered in [Crawler Reads URLs, Search Finds URLs](/docs/notes/2026/06/2026-06-02-crawler-reads-urls-search-finds-urls).
...
<div className="grid gap-4 md:grid-cols-2">
  ...
  <Card title="Retrieval Tags">
    <div className="not-prose flex flex-wrap gap-2">
        ...
        <span className="rounded-full px-2.5 py-1 text-xs font-medium bg-slate-100 text-slate-700 dark:bg-slate-800 dark:text-slate-200">validation</span>
    </div>
