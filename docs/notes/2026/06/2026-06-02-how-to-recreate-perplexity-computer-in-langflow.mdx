...
这篇文章保留为独立 case study，因为它讨论的是 Computer-like runtime，而不是重新讲搜索、Deep Research 或 BrowserOS。搜索流水线见 [Recreate Perplexity Search With LangFlow](/docs/notes/2026/06/2026-06-02-recreate-perplexity-search-with-langflow)，研究循环见 [Deep Research Is An Orchestration Loop](/docs/notes/2026/06/2026-06-02-deep-research-is-an-orchestration-loop)，真实浏览器 MCP 自动化见 [用 BrowserOS MCP 做浏览器自动化](/docs/notes/2026/06/2026-06-02-browseros-mcp)。
  ...
  <Card title="Retrieval Tags">
    ...
    <div className="not-prose mt-5 border-t border-slate-200 pt-4 dark:border-slate-800">
      ...
      <div className="flex flex-wrap gap-2">
        ...
        <span className="rounded-md border border-slate-200 px-2.5 py-1 text-xs font-medium text-slate-600 dark:border-slate-700 dark:text-slate-300">BrowserOS MCP</span>
      </div>
    </div>
  </Card>
</div>
