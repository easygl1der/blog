...
<div className="grid gap-4 md:grid-cols-2">
  ...
  <Card title="Retrieval Tags">
    <div className="not-prose flex flex-wrap gap-2">
        ...
        <span className="rounded-full px-2.5 py-1 text-xs font-medium bg-slate-100 text-slate-700 dark:bg-slate-800 dark:text-slate-200">docker</span>
    ...
    <div className="not-prose mt-5 border-t border-slate-200 pt-4 dark:border-slate-800">
      ...
      <div className="flex flex-wrap gap-2">
        ...
        <span className="rounded-md border border-slate-200 px-2.5 py-1 text-xs font-medium text-slate-600 dark:border-slate-700 dark:text-slate-300">VPS deployment</span>
      </div>
    </div>
  </Card>
</div>
